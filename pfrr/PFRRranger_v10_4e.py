...
##        yyyymmdd = now.replace("-", "")
        ...
        #param1.value = -149.906682
        #param2.value = 67.264536
        param3.value = 21
...
##            d1x = parameters[4].valueAsText
##            m1x = parameters[5].valueAsText
##            s1x = parameters[6].valueAsText
##            parameters[1].value = float(d1x)*-1 + (float(m1x)/60 + float(s1x)/3600)
