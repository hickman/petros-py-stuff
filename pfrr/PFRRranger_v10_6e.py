...
##        yyyymmdd = now.replace("-", "")
        ...
        params = [param0, param1, param2, param3, param4, param5, param6, param7, param8, param9, paramDMS]
        param0.value = "TestMission"  # + datetime.now().strftime("%Y%m%d%H%M")
        param1.value = 0  #-149.906682
        param2.value = 0  #67.264536
        param3.value = 21
        param4.value = 0
        param5.value = 0
        param6.value = 0
