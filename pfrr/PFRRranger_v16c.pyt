...
##            parameters[8].value = Km
    ...
    def execute(self, parameters, messages):
        ...
        epPoint_dbf = "C:/gina/poker/dbf/ep_info.dbf"
        epPointGcs_shp = "C:/gina/poker/scratch/epPointGcs.shp"
        #epPoint3338_shp = "C:/gina/poker/scratch/epPoint3338.shp"
        #epPointLyr = "epPointLyr1"
        #epTgtSrs = arcpy.SpatialReference("Alaska Albers Equal Area Conic")
        epLine_shp = "C:/gina/poker/scratch/epLine.shp"
        epLineLyr = "epLineLyr1"
        #fpPoint_shp = "C:/gina/poker/scratch/fpPoint.shp"
        ...
        #sp_symb = arcpy.mapping.Layer("C:/gina/poker/lyr/sp.lyr")
        ln_symb = arcpy.mapping.Layer("C:/gina/poker/lyr/ln.lyr")
        #fp_symb = arcpy.mapping.Layer("C:/gina/poker/lyr/fp.lyr")
...
#######  Update for modified params 9, 10, 11, and 12  #######
        ...
        if not parameters[0].altered:   # DMS unchecked
            ...
            if parameters[1].value and parameters[2].value and parameters[3].value and parameters[4].value:
                ...
                parameters[9].value = str(round(((rd[1]*-1)+360),1)) + u'\xb0'
                parameters[10].enabled = 1
                parameters[10].value = str(round(rd[0],1))
...
class PFRR(object):
    ...
    def execute(self, parameters, messages):
        ...
        arcpy.CreateFileGDB_management("C:/gina/poker/gdb", parameters[0].valueAsText)
        arcpy.env.workspace = "C:/gina/poker/gdb/" + parameters[0].valueAsText + ".gdb"
        arcpy.env.overwriteOutput = True
        ...
        afs_known_sites = "C:/gina/poker/shp/afs_data/asf_known_sites_20180629_3338.shp"
        ...
        pip_range_rings_shp = "C:/gina/poker/pip/pip_range_rings.shp"
        ...
        pip_known_sites_in_buffer_shp = "C:/gina/poker/pip/pip_known_sites_in_buffer.shp"
        ...
        sourcePipSymbologyLayer = arcpy.mapping.Layer("C:/gina/poker/lyr/pip2.lyr")
        sourceRrsSymbologyLayer = arcpy.mapping.Layer("C:/gina/poker/lyr/rrs.lyr")
        sourcePopSymbologyLayer = arcpy.mapping.Layer("C:/gina/poker/lyr/pop.lyr")
        sourceAfsSymbologyLayer = arcpy.mapping.Layer("C:/gina/poker/lyr/afs2.lyr")
