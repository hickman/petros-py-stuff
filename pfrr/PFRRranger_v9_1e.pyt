...
class Toolbox(object):
    def __init__(self):
        ...
        self.tools = [Oblate, PFRR]

class Oblate(object):
    def __init__(self):
        """Define the tool (tool name is the name of the class)."""
        self.label = "Oblate Tools"
        self.description = "This tool calculates either 1) the range and bearing" + \
        "between two points (initial point and final point), or 2) the final point" + \
        "if given the initial point, range and bearing."
...
##            direction="Output")
        ...
        param0.value = -147.483639  # pfrr lon
        param1.value = 65.130278    # pfrr lat
        param2.value = -149.906682  # pip lon
        param3.value = 67.264536    # pip lat
        param4.value = 360          # azimuth
