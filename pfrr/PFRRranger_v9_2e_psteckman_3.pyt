...
class Ending_Point(object):
    ...
    def getParameterInfo(self):
        ...
        param5 = arcpy.Parameter(
            displayName="Distance (in Feet)",
            name="DistanceFt",
            datatype="GPString",
            parameterType="Required",
            direction="Output") ## changed to output for debugging
...
##            direction="Output")
        ...
        param5.value = "" ## ft # Distance in feet -- commented out to debug
