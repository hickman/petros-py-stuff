# -*- coding: utf-8 -*-
# ---------------------------------------------------------------------------
# pfrr_ranger_20170925_1.py
# Created on: 2017-09-25 15:48:38.00000
#   (generated by ArcGIS/ModelBuilder)
# Usage: pfrr_ranger_20170925_1 <Enter_Longitude__in_Decimal_Degrees_> <Enter_Latitude__in_Decimal_Degrees_> <Enter_the_3σ_circle_Radius_and_Distance_Unit>
# Description:
...
Enter_the_3σ_circle_Radius_and_Distance_Unit = arcpy.GetParameterAsText(2)
if Enter_the_3σ_circle_Radius_and_Distance_Unit == '#' or not Enter_the_3σ_circle_Radius_and_Distance_Unit:
    Enter_the_3σ_circle_Radius_and_Distance_Unit = "4 Miles" # provide a default value if unspecified
...
v3σ_Circle_Output = "E:\\gina\\poker\\pip\\pip_buffer.shp"
adnr_gls_dls_merge_20170823_v1_shp = "E:\\gina\\poker\\shp\\wip\\adnr_gls_dls_merge_20170823_v1.shp"
Land_Ownership_within_3σ_Circle = "E:\\gina\\poker\\pip\\pip_buffer_intersect_land_ownership.shp"
...
# Process: Buffer
arcpy.Buffer_analysis(predicted_impact_xy_Layer, v3σ_Circle_Output, Enter_the_3σ_circle_Radius_and_Distance_Unit, "FULL", "ROUND", "NONE", "", "PLANAR")

# Process: Intersect
arcpy.Intersect_analysis("E:\\gina\\poker\\pip\\pip_buffer.shp #;E:\\gina\\poker\\shp\\wip\\adnr_gls_dls_merge_20170823_v1.shp #", Land_Ownership_within_3σ_Circle, "ALL", "", "INPUT")
